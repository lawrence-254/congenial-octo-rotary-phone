...
const { getChats, getMyChats, createGroupChat, addToChat, removeFromChat, renameGroupChat, deleteGroupChat } = require('../controllers/chatController');
...
router.route('/groupRemove').post(protect, chatController.removeFromChat);
